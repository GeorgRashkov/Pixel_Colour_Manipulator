...
class Window_Form_pixel_areas_masks(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        big_int_validator = QIntValidator(0, 999_999, self)     
        ...
        self.button_alter_or_add_rgb_formula_id = QPushButton("alter/add rgb formula")
        self.button_alter_or_add_rgb_formula_id.setMaximumWidth(120)
        self.label_rgb_formula_id = QLabel("id")
        self.textBox_rgb_formula_id = QLineEdit("1")
        self.textBox_rgb_formula_id.setMaxLength(3)
        self.textBox_rgb_formula_id.setMaximumWidth(30)
        self.textBox_rgb_formula_id.setValidator(big_int_validator)
        ...
        h_layout = QHBoxLayout()
        h_layout.addWidget(self.button_alter_or_add_rgb_formula_id)
        h_layout.addWidget(self.textBox_rgb_formula_id)
